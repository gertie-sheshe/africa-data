export default {
    Kenya: {
        ...
        cities: ['Nairobi', 'Mombasa', 'Nakuru', 'Ruiru', 'Eldoret', 'Kisumu', 'Kikuyu', 'Thika', 'Naivasha', 'Karuri'],
        citiesPopulation: [4397073, 1208333, 570674, 490120, 475716, 397957, 323881, 251407, 198444, 194342],
        ethnic: ['Kikuyu', 'Luhya', 'Kalenjin', 'Luo', 'Kamba', 'Somalis', 'Kisiis', 'Mijikenda', 'Other'],
    ...
    Uganda: {
        ...
        cities: ['Kampala', 'Nansana', 'Kira', 'Ssabagabo', 'Mbarara', 'Mukono', 'Njeru', 'Gulu', 'Lugazi', 'Masaka'],
        citiesPopulation: [1507080, 365124, 31757, 283272, 195531, 162710, 159549, 150306, 114524, 103227],
        ethnic: ['Baganda', 'Banyankole', 'Basoga', 'Bakiga', 'Iteso', 'Langi', 'Bagisu', 'Acholi', 'Lugbara', 'Other'],
